        ...
        <ScrollView style={{ flexGrow: 1 }}> 
          <Table className="w-full">
            <TableHeader className={tableHeaderClass}>
              <TableRow>
                <TableHead className={`py-2 px-3 font-bold text-left ${textColorClass} w-[60%]`}>Department</TableHead>
            ...
            <TableBody>
              {productCounts.map((data, index) => (
                ...
                >
                  <TableData className={`py-2 px-3 text-left ${tableContentTextColorClass}`}>
                    {data.Department === "IFY" ? "I Found You" : "No Time to Hell"
                    }
                  </TableData>
