...
<style>
    ...
    .input-group-text {
        ...
        padding-right: 12px;
        /* This adds the space between +62 and the input */
    }
    ...
    .login__form .input-group .form-control {
        ...
        /* Assuming your existing inputs are transparent */
        border: none;
        border-bottom: 1px solid #4a4a4a;
        /* Matches the visual style from your original code */
        color: #fff;
