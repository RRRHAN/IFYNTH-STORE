...
<main>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-8 mt-2">
                <div class="form-group">
                    <label for="productMedia">Foto / Video Produk (Upload lebih dari satu file)</label>
                    <input type="file" id="productMedia" name="product_media[]" class="form-control" multiple required>
                </div>
            </div>
            ...
            <!-- Submit Button -->
            <div class="col-md-8">
                <button type="submit" class="btn-one mt-5"><span>Tawarkan Produk</span></button>
            </div>
        </div>
    </div>
</form>
