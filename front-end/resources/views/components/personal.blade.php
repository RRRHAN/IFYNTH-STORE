    ...
    <form action="{{ route('update.profile')}}" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="tel" class="form-control" name="phone_number" value="{{ session('user')['PhoneNumber'] ?? '' }}">
            </div>
            <div class="col-md-6">
            ...
            <div class="mb-3 row">
                <div class="col-md-8">
                    ...
                    <input type="text" class="form-control" id="searchDestinaton" placeholder="e.g., Surabaya" value="{{ session('user')['CustomerDetails']['DestinationLabel'] ?? '' }}
"
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="zip_code" name="zip_code" maxlength="5" value="{{ session('user')['CustomerDetails']['ZipCode'] ?? '' }}
"
